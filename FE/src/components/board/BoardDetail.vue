    ...
    <b-col>
      <div style="text-align: right; margin-right: 7px">
        <a
          ...
          >
            <path
              d="M3.75 9.69 7.5 6.12l3.75 3.571"
              stroke="#444"
              stroke-width="2"
        ...
        <a
          ...
          >
            <path
              d="M3.75 5.344 7.5 8.906l3.75-3.562"
              stroke="#444"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
  ...
  <b-row>
    ...
    <b-col>
      ...
      <b-row>
        ...
        <b-col
          cols="8"
          style="padding: 0px 0px; text-align: right; padding-right: 10px"
        >
          <svg
            width="22"
            height="17"
...
export default {
  ...
  setup(){
    ...
    return {store, selectedBoard, user, isLogin, messages, bottom, message, send};
  },
  props: {
    index: Number,
    number: Number,
