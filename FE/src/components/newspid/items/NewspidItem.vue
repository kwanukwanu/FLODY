    ...
    <b-row style="margin-bottom:10px;">
      ...
      <b-col>
        <b-row
          ...
          <span style="padding: 0px; font-size: 14px; width:80%"><a style="font-weight:500;">{{ userId }}</a>
            {{ contents }}</span><span style="width:20%; text-align:right">
            <a style="text-align: right; padding: 0px; font-weight: bold; text-decoration: none;"><svg width="12"
                height="12" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!--좋아요 눌렀다면 아래 코드-->
          <!-- <a style="text-align: right; padding: 0px; font-weight: bold; text-decoration: none;"><svg width="12" height="12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.004.021C4.694-.184 5.794 1.157 6 1.725 6.207 1.157 7.454-.167 8.996.021c2.29.28 3.099 2.556 2.995 4.138-.087 1.335-.31 2.556-2.789 5.111-1.145 1.181-1.956 1.96-2.482 2.437-.431.39-1.009.39-1.44 0-.526-.478-1.336-1.256-2.482-2.437C.318 6.715.096 5.494.008 4.16-.094 2.577.707.301 3.005.021Z" fill="#F0355B"/></svg></a> -->
        </b-row>
        ...
        <b-row>
          <b-col
            ...
            <span style="font-size: 12px;" class="bottom_like_comment">좋아요 {{ favor }}개&nbsp;&nbsp;&nbsp;</span>
