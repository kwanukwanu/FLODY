<template>
    ...
    <b-col cols="9">
        <b-row>
            <span
                style="display: inline; padding: 0px; text-align: left; font-weight: 500; font-size: 14px; margin-top:5px; font-family : -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; width:70%"><a>
                    adrianycc</a>
                <b-button
    ...
    <b-col cols="1" style="padding: 0px 0px; margin-top: 8px;">
        <b-button size="sm" variant="link" style="width: 40px; text-decoration: none; padding:0px 0px;"
            v-b-modal.modal-4>
