...
async function get_boardList(category, success, fail) {
  ...
  await api.get(`/posts?category=${category}`, JSON.stringify(category)).then(success).catch(fail);
}
...
async function get_board(posNo, success, fail) {
  ...
  console.log(posNo);
  await api.get(`/post?posNo=${posNo}`, JSON.stringify(posNo)).then(success).catch(fail);
}
...
async function get_comments(posNo, success, fail) {
  ...
  console.log(posNo);
  await api.get(`/commnets?posNo=${posNo}`, JSON.stringify(posNo)).then(success).catch(fail);
}
...
async function regist_comment(commentInfo, success, fail) {
  ...
  await api.post(`/comment`, JSON.stringify(commentInfo)).then(success).catch(fail);
}
...
async function modify_comment(commentInfo, success, fail) {
  ...
  console.log(commentInfo);
  await api.put(`/comment`, JSON.stringify(commentInfo)).then(success).catch(fail);
}
